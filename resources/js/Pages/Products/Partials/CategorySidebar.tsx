        ...
        <section className="hidden md:block">
            ...
            <nav className="space-y-1.5">
                <Link
                    ...
                    className={`flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group ${!url.includes('category') ? 'bg-purple-900 text-white shadow-lg shadow-primary/20' : 'hover:bg-white text-slate-600 hover:text-primary hover:shadow-sm'}`}
                >
                ...
                {categories.map((category) => {
                    ...
                    return (
                        <Link
                            ...
                            className={`flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 group ${isActive ? 'bg-purple-900 text-white shadow-lg shadow-primary/20' : 'hover:bg-white text-slate-600 hover:text-primary hover:shadow-sm'}`}
                        >
